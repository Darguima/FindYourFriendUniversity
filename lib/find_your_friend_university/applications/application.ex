defmodule FindYourFriendUniversity.Applications.Application do
  ...
  def changeset(application, attrs) do
    ...
    |> validate_number(:_11grade, greater_than_or_equal_to: 0, less_than_or_equal_to: 20)
    |> validate_number(:_12grade, greater_than_or_equal_to: 0, less_than_or_equal_to: 20)
    |> validate_number(:candidature_grade, greater_than_or_equal_to: 0, less_than_or_equal_to: 20)
    |> validate_number(:exams_grades, greater_than_or_equal_to: 0, less_than_or_equal_to: 20)
