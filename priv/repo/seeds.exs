...
], fn student -> Students.create_student(student) end)

Enum.each([
  %{course_order_num: 1, candidature_grade: 14, exams_grades: 15, _12grade: 16, _11grade: 14, student_option_number: 1, placed: true, year: 2018, phase: 1, university: 1, course: 1, student: 1},
  %{course_order_num: 2, candidature_grade: 13, exams_grades: 14, _12grade: 15, _11grade: 14, student_option_number: 2, placed: false, year: 2018, phase: 1, university: 5, course: 5, student: 1},
  %{course_order_num: 3, candidature_grade: 15, exams_grades: 14, _12grade: 15, _11grade: 14, student_option_number: 3, placed: true, year: 2018, phase: 1, university: 2, course: 2, student: 1},
  %{course_order_num: 4, candidature_grade: 14, exams_grades: 14, _12grade: 16, _11grade: 13, student_option_number: 1, placed: false, year: 2018, phase: 1, university: 6, course: 4, student: 2},
  %{course_order_num: 5, candidature_grade: 16, exams_grades: 14, _12grade: 15, _11grade: 14, student_option_number: 2, placed: true, year: 2018, phase: 1, university: 2, course: 1, student: 2},
  %{course_order_num: 6, candidature_grade: 14, exams_grades: 15, _12grade: 15, _11grade: 14, student_option_number: 1, placed: false, year: 2018, phase: 1, university: 1, course: 3, student: 3},
  %{course_order_num: 7, candidature_grade: 15, exams_grades: 14, _12grade: 15, _11grade: 14, student_option_number: 1, placed: true, year: 2018, phase: 1, university: 5, course: 5, student: 5}
], fn application -> Applications.create_application(application) end)
